...
:::info FR-006: Contextual Humanity
...
### 1. What is Physical AI? :::info FR-005: Modular Mind
:::
...
### 3. Traditional AI vs. Embodied AI :::info FR-005: Modular Mind
:::
...
### 4. Historical Milestones :::info FR-006: Contextual Humanity
:::
...
**Tools**: You will use Python and a lightweight physics library (e.g., `pybullet` or `mujoco` free tier). :::info FR-007: Technology Critique - This tool is chosen because it allows direct manipulation of physics and simple robot models, clearly demonstrating embodied interaction.
:::
...
## Creative Challenge: Beyond the Static Robot :::info FR-004: Creative Synthesis
:::
...
## Technology Deep Dive: Simulation as a Foundation :::info FR-007: Technology Critique
:::
